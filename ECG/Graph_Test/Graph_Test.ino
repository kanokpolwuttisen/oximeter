...
//    Trace(tft, x, y, 1, 60, 290, 390, 260, 0, 6.5, 1, -1, 1, .25, "Sin(x) + Cos(x) + Tan(x)", " x", "fn(x)", update1, CYAN);
 // }
  ...
  tft.fillRect(0, 60, 30, 10, DKGREEN);
  delay(800);
  tft.fillRect(0, 60, 60, 10, DKGREEN);
  delay(800);
  tft.fillRect(0, 60, 90, 10, DKGREEN);
  delay(800);
  tft.fillRect(0, 60, 120, 10, DKGREEN);
  delay(800);

  
  tft.drawCircle(120, 65, 20,LTORANGE);
  delay(1000);
  
  tft.drawEllipse(100, 65,30, 10,LTORANGE);
  delay(500);
  tft.drawEllipse(120, 45,10, 30,LTORANGE);
  delay(500);
  tft.drawEllipse(140, 65,30, 10,LTORANGE);
  delay(500);
  tft.drawEllipse(120, 85,10, 30,LTORANGE);
  delay(500);  
  tft.fillCircle(120, 65, 20,LTORANGE);
  delay(1000);
  tft.fillEllipse(100, 65,30, 10,ORANGE);
  delay(500);
  tft.fillEllipse(120, 45,10, 30,ORANGE);
  delay(500);
  tft.fillEllipse(140, 65,30, 10,ORANGE);
  delay(500);
  tft.fillEllipse(120, 85,10, 30,ORANGE);
  delay(500);  

  tft.fillEllipse(120, 65,60, 20,RED);
  delay(500);
  tft.fillEllipse(120, 65,20, 60,RED);
  delay(500);
  tft.fillCircle(120, 65, 20,LTORANGE);
  delay(1500);
  tft.setTextColor(TEAL);
  tft.setTextSize(3);
  tft.drawString("Amour",10,10);
